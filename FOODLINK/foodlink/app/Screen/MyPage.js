...
import { styles } from "../Style/MyPage.style";
import CmPostList from "./CmPostList"; // CmPostList 컴포넌트
import RecipeList from "./RecipeList"; // RecipeList 컴포넌트
      ...
      <View style={styles.myIngredientsSection}>
        <View style={styles.myIngredientsHeader}>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate("MyFoodScreen")}
          >
